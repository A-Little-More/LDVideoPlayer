...
@implementation LDBrightnessView
...
- (UIImageView *)backImage {
    ...
    if (!_backImage) {
        _backImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 76, 76)];
...
#pragma mark - 单例
+ (instancetype)sharedLDBrightnessView {
	static LDBrightnessView *instance;
	static dispatch_once_t onceToken;
	dispatch_once(&onceToken, ^{
		instance = [[LDBrightnessView alloc] init];
...
- (void)setupUI {
    self.frame = CGRectMake(kScreenWidth * 0.5, kScreenHeight * 0.5 - 20, 155, 155);
    ...
    switch (currInterfaceOrientation)
    {
        ...
        case UIInterfaceOrientationLandscapeLeft:
        {
            ...
            [UIView animateWithDuration:0.25 animations:^{
                ...
                self.center = CGPointMake(kScreenHeight * 0.5, (kScreenWidth - 10) * 0.5);
            }];
        }
            break;
